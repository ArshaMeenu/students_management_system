    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_type', models.PositiveSmallIntegerField(choices=[(1, 'Admin'), (3, 'Lecturer'), (2, 'Student')], default=1, verbose_name='User Types')),
                ...
                ('profiles', models.FileField(null=True, upload_to='profiles', validators=[django.core.validators.FileExtensionValidator(['svg', 'jpg', 'jpeg', 'png', 'webp'])], verbose_name='user profile')),
